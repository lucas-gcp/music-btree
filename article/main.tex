...
pelos grandes serviços de streaming, como Spotify, Deezer e Youtube Music.
...
democratizado a um sistema de busca, visando impulsionar o desenvolvimento de
...
\emph{Existem muitos estudos focados no desenvolvimento de métodos de indexação
...
que são relativamente antigos mas perpetuados na busca em serviços de streaming
da atualidade, são evidenciados por Nanopoulos et al. no artigo de 2009. Nele, é
...
Na atualidade, os serviços de streaming de música, como indicado Li et al. no
artigo de 2019, os mecanismos de busca, para manter certa qualidade precisam
balancear o específico do abrangente, em que dependendo do indivíduo que irá
pesquisar, ele terá uma mentalidade diferente, que, de acordo com o artigo
mencionado, pode ser dividida em dois grupos: focada e não focada. O usuário com
a mente focada procura algo em particular, que seria agregado com o projeto, em
especificidade no gênero de música clássica, enquanto o não focado possui uma
ideia vaga do que busca, estando aberto a sugestões. Diante disso, é mostrado a
